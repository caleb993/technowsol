...
HUB_TOOLS = [
    ...
    {"slug":"port-scanner","anchor":"port-scanner","title":"Port Scanner Awareness Tool","icon":"bi-hdd-network","description":"Check common ports on your own router or lab host and learn what open services may mean."},
...
HUB_TOOL_GUIDES = {
    ...
    "port-scanner": {"heading":"Port Scanner Awareness Tool for safe network checks", "intro":"Use this beginner-friendly tool to review common TCP ports on systems you own or are authorized to test, such as your own router, localhost lab or approved office device. It explains what ports commonly mean and reminds users to test only with permission.", "uses":["Learn what common ports such as 22, 80, 443 and 3389 are used for","Document your own router or lab exposure safely","Support ICT awareness without scanning systems you do not own"]},
